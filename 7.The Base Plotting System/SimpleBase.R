...
with(airquality , {
  ...
  with(subset(airquality,Month == 6),points(Wind,Ozone,col = "blue" , pch = 20))
  with(subset(airquality,Month == 7),points(Wind,Ozone,col = "red" , pch = 20))
  with(subset(airquality,Month == 8),points(Wind,Ozone,col = "green" , pch = 20))
  abline(lm(Ozone~Wind) , lwd = 2)
  legend("topleft",pch = 20 , col = c("blue","red","green"), legend = c("June","July","August"))
  ...
  with(subset(airquality,Month == 6),points(Temp,Ozone,col = "blue" , pch = 20))
  with(subset(airquality,Month == 7),points(Temp,Ozone,col = "red" , pch = 20))
  with(subset(airquality,Month == 8),points(Temp,Ozone,col = "green" , pch = 20))
  abline(lm(Ozone~Temp) , lwd = 2)
  legend("topleft",pch = 20 , col = c("blue","red","green"), legend = c("June","July","August"))
